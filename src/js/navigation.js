...
export default (function () {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    helpers.coursesInfo(nodes.vouchersInfoClick, nodes.$vouchersInfo);
    helpers.coursesInfo(nodes.individualLessonsInfoClick, nodes.$individualLessonsInfo);
    helpers.coursesInfo(nodes.distanceLearningInfoClick, nodes.$distanceLearningInfo);
  });
})();
